...
interface ArticleContextType {
    ...
    getArticle: (id: string) => Promise<GetArticleQuery['article'] | null>;
...
export const ArticleProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <ArticleContext.Provider value={{ createArticle: create, updateArticle: update, deleteArticle: remove, getArticle, getArticles }}>
            {children}
