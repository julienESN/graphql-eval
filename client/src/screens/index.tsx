...
import { MeQuery, MeQueryVariables } from '../generated/graphql'; // Types générés par GraphQL Codegen
    ...
    <div className="p-6 mx-32">
      ...
      <div className="mb-4">
        <label htmlFor="filter">
          <strong>Filtrer par titre : </strong>
        </label>
        <input
          type="text"
        ...
        <div>
          ...
          {data.map((article) => (
            <div key={article.author.id}>
              ...
              />
              <label htmlFor={`author-${article.author.id}`}>
                {article.author.name}
              </label>
            </div>
          ))}
